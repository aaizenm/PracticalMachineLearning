...
```{r}
Based on our problem: multi-dimensional classification with number of observations much exceeding the number of predictors,
...
```{r}
model2 <- randomForest(classe ~ ., data = finaltrain_train, ntree = 1024)
model2
It will give us an OOB estimate of  error rate: 0.5%

Let's try with ntree=2048
